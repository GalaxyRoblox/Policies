...
- Using an alternate Discord account to bypass a moderation action.
    ...
    - If the main account was banned for a forbidden infraction, all future alts linked back to the offender and existing known alternate accounts should be permanently banned.
